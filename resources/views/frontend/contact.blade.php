...
<!-- Mirrored from tk-themes.net/html-organici/html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Aug 2019 10:00:31 GMT -->
<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/>
		<link rel="shortcut icon" href="images/favicon.ico"/>
		<title>Contact - Organic Store | HTML Template</title>

		<link rel='stylesheet' href='css/bootstrap.min.css' type='text/css' media='all' />
		<link rel='stylesheet' href='css/owl.carousel.css' type='text/css' media='all'/>
		<link rel='stylesheet' href='css/owl.theme.css' type='text/css' media='all'/>
		<link rel='stylesheet' href='css/font-awesome.min.css' type='text/css' media='all'/>
		<link rel='stylesheet' href='../../../fonts.googleapis.com/csse7d6.css?family=Lato:100,300,400,700,900,300italic,400italic,700italic,900italic' type='text/css' media='all'/>
		<link rel='stylesheet' href='../../../fonts.googleapis.com/css8036.css?family=Pacifico:100,300,400,700,900,300italic,400italic,700italic,900italic' type='text/css' media='all'/>
		<link rel='stylesheet' href='../../../fonts.googleapis.com/cssa8b0.css?family=Anonymous+Pro:' type='text/css' media='all'/>
		<link rel="stylesheet" href="../../../fonts.googleapis.com/cssa221.css?family=Roboto:700" type="text/css" media="all"/>
		...
		<div class="site">
											...
											<div class="noo-minicart">
												...
												<div class="minicart-footer">
													<div class="minicart-actions clearfix">
														<a class="button pull-left button-null btn-primary" href="shop.html">
													...
													<div class="noo_megamenu_widget_area">
														<div class="widget commerce widget_products">
															...
															<ul class="product_list_widget">
																<li>
																	<a href="shop-detail.html">
																		<img width="100" height="100" src="images/product/thumb/product_4.jpg" alt="" /> 
																		<span class="product-title">French Bread</span>
																	</a>
																	<span class="amount">&#36;10.00</span>
																</li>
																...
																<li>
																	<a href="shop-detail.html">
																		<img width="100" height="100" src="images/product/thumb/product_5.jpg" alt="" /> 
																		<span class="product-title">Brown Bread</span>
																	</a>
																	<span class="amount">&#36;12.00</span>
																</li>
			...
			<section class="noo-page-heading eff heading-blog">
				<div class="container">
					<div class="noo-heading-content">
						<h1 class="page-title eff">Contact Us</h1>
						<div class="noo-page-breadcrumb eff">
							<a href="index-7.html" class="home">Organici</a>/<span>Contact Us</span>
						</div>
					</div>
				</div>
			</section>
			<div class="main">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<form class="form">
									<h3>Get in touch</h3>
									<p>
										Aliquam vitae mi a eros tincidunt ultricies. Donec porta gravida arcu. Morbi facilisis lorem felis, eu inerdum quam scelerisque eu.
									</p>
									<div class="row">
										...
										<div class="col-md-6 col-sm-12">
											<div class="form-control-wrap your-website">
												<input type="text" name="your-website" value="" size="40" class="form-control" placeholder="Website"/>
											</div>
										</div>
										<div class="col-md-6 col-sm-12">
										...
										<div class="col-md-6 col-sm-12">
											<div class="form-control-wrap your-phone">
												<input type="text" name="your-phone" value="" size="40" class="form-control" placeholder="Phone"/>
											</div>
										</div>
										<div class="col-md-12">
				...
				<div class="google-map">
					<div id="googleMap" data-icon="images/icon_location.png" data-lat="37.789133" data-lon="-122.402158"></div>
							...
							<div class="address-info">
								...
								<ul>
									<li>
										...
										<span>69 South Park Avenue San Francisco, CA 14782 USA</span>
									</li>
									<li>
									...
									<li>
										...
										<span>(00) 123 456 789</span></li>
									<li>
										<i class="fa fa-globe"> </i>
										<span><a href="#">http://www.companyname.com</a></span>
									</li>
								</ul>
							</div>
						</div>
...
<!-- Mirrored from tk-themes.net/html-organici/html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Aug 2019 10:00:33 GMT -->
</html>