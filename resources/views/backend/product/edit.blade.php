                  ...
                  <form action="" method="post" enctype="multipart/form-data" class="">
                    <div class="row form-group">
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                              <input type="text" id="text-input" name="pro_name" placeholder="Text" class="form-control" value="{{$product->pro_name}}">
                          </div>
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                              <input type="number" id="pro_price" name="pro_price" placeholder="Price..." class="form-control"  value="{{$product->pro_price}}">
                          </div>
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                              <input type="file" id="id="file-input"" name="pro_image"  class="form-control-file" value="{{$product->pro_image}}">
                          </div>
                        ...
                        <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                              <textarea name="pro_description" id="editor1" rows="8" cols="80" value="{{$product->pro_description}}"></textarea>
                          </div>
